...
#[ApiResource(
    ...
    mcp: [
        ...
        'update_footprint' => new McpTool(
            ...
            security: 'is_granted("@footprints.edit")',
        ...
        'delete_footprint' => new McpTool(
            ...
            security: 'is_granted("@footprints.delete")', // The processor returns a plain text confirmation via CallToolResult, not a normalized element
