...
class HistoryHelper
{
     ...
     */
    public function getAssociatedElements(AbstractDBElement $element, bool $includeProjectBomEntries = true): array
    {
        $array = [$element];
        ...
        if ($includeProjectBomEntries && $element instanceof Project) {
