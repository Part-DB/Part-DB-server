 ...
 * math, rounding and logging is delegated to PartLotWithdrawAddHelper; lot resolution, authorization, timestamp
 * handling, the editing-enabled guard and process()/error-wrapping are all inherited - see AbstractPartLotStockProcessor.
 */
final class WithdrawPartStockProcessor extends AbstractPartLotStockProcessor
{
